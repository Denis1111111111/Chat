...
{
    let text = document.getElementById("writeNamePersonRemove").value;

	if (text == "") {
		return;
	}

	document.getElementById("writeNamePersonRemove").value = "";
...
function RemoveBan()
{
    let text = document.getElementById("writeNamePersonRemoveBan").value;

	if (text == "") {
		return;
	}

	document.getElementById("writeNamePersonRemoveBan").value = "";
...
function ban()
{
    let text = document.getElementById("writeNamePersonBanned").value;

	if (text == "") {
		return;
	}

	document.getElementById("writeNamePersonBanned").value = "";
...
function identificateMessage(message) {
	...
	switch (context.commandName) {
		...
		case "SendMessageInCloseRoom":
			{
                document.getElementById(context.commandContext).style.background='#FF0000';
				break;
			}
	}
}
